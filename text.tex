...
\includegraphics[width=\textwidth]{gat.png}
...
\includegraphics[width=\textwidth]{sage.png}
...
\includegraphics[width=\textwidth]{gcn_train.png}

The change in values by epoch on GAT is reflected in the graph:

\includegraphics[width=\textwidth]{gat_train.png}

The change in values by epoch on GraphSAGE is reflected in the graph:

\includegraphics[width=\textwidth]{sage_train.png}
...
\includegraphics[width=\textwidth]{gcn_test.png}

The change in values by epoch on GAT is reflected in the graph:

\includegraphics[width=\textwidth]{gat_test.png}

The change in values by epoch on GraphSAGE is reflected in the graph:

\includegraphics[width=\textwidth]{sage_test.png}
...
// https://arxiv.org/pdf/1706.02216.pdf GraphSAGE
// https://peerj.com/articles/cs-526/
